# Database access {#sec-db-access}

The OSSL is distributed through Google Cloud Storage bucket, MongoDB (deprecated), and [API (experimental)](https://api.soilspectroscopy.org/__docs__/#/).
...
[SoilSpecData](https://fr.anckalbi.net/soilspecdata/) is a Python package for handling soil spectroscopy data, with a focus on the Open Soil Spectral Library (OSSL).

Please follow the instructions available on the official [package website](https://fr.anckalbi.net/soilspecdata/).
...
<!-- ::: {.callout-warning} -->
<!-- # Note -->
<!-- Within MongoDB, all the dots in variable/column names are replaced by underscore -->
<!-- ::: -->
