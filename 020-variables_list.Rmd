...
kssl.yw = readRDS.gz("/mnt/diskstation/data/ossl/dataset/KSSL/kssl_ossl.soillab.rds")
kssl.sitef = readRDS.gz("/mnt/diskstation/data/ossl/dataset/KSSL/kssl_ossl.soilsite.rds")
...
```{r, hist-oc_usda.calc_wpct, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for soil organic carbon in wpct."}
...
```{r, hist-ph.h2o_usda.4c1, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for soil pH."}
