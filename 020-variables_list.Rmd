...
```{r, plot-bd, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Bulk density in t/m3."}
...
```{r hist-bd1, echo=FALSE, fig.cap="Bulk density in t/m3 percent histograms.", out.width="70%"}
