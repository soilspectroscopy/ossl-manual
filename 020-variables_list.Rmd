...
if(!exists("ossl.yw")){
  ossl.yw = readRDS(url("http://s3.us-east-1.wasabisys.com/soilspectroscopy/ossl_import/ossl_soillab_v1.rds", "rb"))  
}
if(!exists("ossl.sitef")){
  ossl.sitef = readRDS(url("http://s3.us-east-1.wasabisys.com/soilspectroscopy/ossl_import/ossl_soilsite_v1.rds", "rb"))
}
ossl.yw$layer.upper.depth_usda_cm = plyr::join(ossl.yw["id.layer_uuid_c"], ossl.sitef, match="first")$layer.upper.depth_usda_cm
ossl.yw$layer.lower.depth_usda_cm = plyr::join(ossl.yw["id.layer_uuid_c"], ossl.sitef, match="first")$layer.lower.depth_usda_cm
ossl.yw$depth = ossl.yw$layer.upper.depth_usda_cm + (ossl.yw$layer.lower.depth_usda_cm - ossl.yw$layer.upper.depth_usda_cm)/2
ossl.yw$dataset.code_ascii_c = plyr::join(ossl.yw["id.layer_local_c"], ossl.sitef, match="first")$dataset.code_ascii_c
ossl.yw = ossl.yw[!is.na(ossl.yw$dataset.code_ascii_c),]
```
...
for(j in c("wpg2_usda.3a2_wpct", "ecec_usda.4b4_cmolkg", "ec.w_usda.4f1_dsm", "oc_usda.calc_wpct",
  ...
  if(!file.exists(out.png)){
    sel.df = ossl.yw[,c("dataset.code_ascii_c", j)]
...
ossl.yw$silt.tot_usda.3a1_wpct = ifelse(ossl.yw$silt.tot_usda.3a1_wpct>100, 100, ossl.yw$silt.tot_usda.3a1_wpct)
...
- `r emo::ji("id")` `al.kcl_usda.4b3_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: KCl extractable  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-alkcl, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Aluminum, KCl extractable in cmol/kg."}
...
```{r hist-alkcl1, echo=FALSE, fig.cap="Aluminum, KCl extractable in cmol/kg histograms.", out.width="70%"}
...
- `r emo::ji("id")` `bd.od_usda.3b2_gcm3`  
- `r emo::ji("library")` Measurement unit: g/cm3  
- `r emo::ji("laboratory")` Laboratory method: Oven-Dry  
- `r emo::ji("open_book")` Scientific reference: @grossman20022   


```{r, plot-bd, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Bulk density in g/cm3."}
...
```{r hist-bd1, echo=FALSE, fig.cap="Bulk density in g/cm3 percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `bsat_usda.4b4_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-bs, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Base saturation in wpct."}
...
```{r hist-bs1, echo=FALSE, fig.cap="Base saturation in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `c.tot_usda.4h2_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Walkley-Black  
- `r emo::ji("open_book")` Scientific reference: @nelson1983total   


```{r, plot-toc, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for total carbon in wpct."}
...
```{r hist-toc1, echo=FALSE, fig.cap="Total carbon in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `ca.ext_usda.4b1_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-exca, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Calcium, NH4OAc Extractable in cmol/kg."}
...
```{r hist-exca1, echo=FALSE, fig.cap="Calcium, NH4OAc Extractable in cmol/kg histograms.", out.width="70%"}
...
- `r emo::ji("id")` `caco3_usda.4e1_wpct`  
- `r emo::ji("library")` Measurement unit: weight percentage  
- `r emo::ji("laboratory")` Laboratory method: 3 N HCl Treatment  
- `r emo::ji("open_book")` Scientific reference: @loeppert1996carbonate   


```{r, plot-caco, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for CaCO3 in wpct."}
...
```{r hist-caco1, echo=FALSE, fig.cap="Organic carbon in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `cec.ext_usda.4b1_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-cec, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for CEC in cmol/kg."}
...
```{r hist-cec1, echo=FALSE, fig.cap="CEC in cmol/kg histograms.", out.width="70%"}
...
- `r emo::ji("id")` `code` clay.tot_usda.3a1_wpct  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Particle-Size Distribution Analysis using Pipette  
- `r emo::ji("open_book")` Scientific reference: @agriculture2019soil   


```{r, plot-clay, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for total clay in wpct."}
...
```{r hist-clay1, echo=FALSE, fig.cap="Total clay content in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `ec.w_usda.4f1_dsm`  
- `r emo::ji("library")` Measurement unit: dS/m  
- `r emo::ji("laboratory")` Laboratory method: ??  
- `r emo::ji("open_book")` Scientific reference: @nelson1983total   


```{r, plot-ec, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Electrical Conductivity in dS/m."}
...
```{r hist-ec1, echo=FALSE, fig.cap="Electrical Conductivity in dS/m histograms.", out.width="70%"}
knitr::include_graphics("hist/ec.w_usda.4f1_dsm_hist.png")
```
...
- `r emo::ji("id")` `ecec_usda.4b4_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @sumner1996cation   


```{r, plot-ecec, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for ECEC in cmol/kg."}
...
```{r hist-ecec1, echo=FALSE, fig.cap="ECEC in cmol/kg histograms.", out.width="70%"}
...
- `r emo::ji("id")` `gyp_usda.4e2_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Aqueous Extraction, Electrical Conductivity  
- `r emo::ji("open_book")` Scientific reference: @elrashidi2007application   


```{r, plot-gyp, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Exchangeable sodium percentage."}
...
```{r hist-gyp1, echo=FALSE, fig.cap="Exchangeable sodium percentage histograms.", out.width="70%"}
...
- `r emo::ji("id")` `k.ext_usda.4b1_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-exk, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Potassium, NH4OAc Extractable in cmol/kg."}
...
```{r hist-exk1, echo=FALSE, fig.cap="Potassium, NH4OAc Extractable in cmol/kg histograms.", out.width="70%"}
...
- `r emo::ji("id")` `mg.ext_usda.4b1_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-exmg, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Magnesium, NH4OAc Extractable in cmol/kg."}
...
```{r hist-exmg1, echo=FALSE, fig.cap="Magnesium, NH4OAc Extractable in cmol/kg histograms.", out.width="70%"}
...
- `r emo::ji("id")` `n.tot_usda.4h2_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Dry oxidation (combustion) procedure   
- `r emo::ji("open_book")` Scientific reference: @bremner1996nitrogen   


```{r, plot-ntot, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for total N in wpct."}
...
```{r hist-ntot1, echo=FALSE, fig.cap="Total N in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `na.ext_usda.4b1_cmolkg`  
- `r emo::ji("library")` Measurement unit: cmol/kg  
- `r emo::ji("laboratory")` Laboratory method: Displacement after Washing, NH4OAC, pH 7 / Atomic Absorption Spectrophotometer  
- `r emo::ji("open_book")` Scientific reference: @thomas1982exchangeable   


```{r, plot-exna, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Sodium, NH4OAc Extractable in cmol/kg."}
...
```{r hist-exna1, echo=FALSE, fig.cap="Sodium, NH4OAc Extractable histograms.", out.width="70%"}
...
- `r emo::ji("id")` `oc_usda.calc_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Walkley-Black organic C method  
- `r emo::ji("open_book")` Scientific reference: @nelson1983total   
...
- `r emo::ji("id")` `ph.cacl2_usda.4c1_index`  
- `r emo::ji("library")` Measurement unit: index  
- `r emo::ji("laboratory")` Laboratory method: Soil suspension combination pH-Reference Electrode  
- `r emo::ji("open_book")` Scientific reference: @mclean1983soil   


```{r, plot-phcl, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Soil pH 1:2 0.01-M calcium chloride."}
...
```{r hist-phcl1, echo=FALSE, fig.cap="Soil pH 1:2 0.01-M calcium chloride histograms.", out.width="70%"}
...
- `r emo::ji("id")` `ph.h2o_usda.4c1_index`  
- `r emo::ji("library")` Measurement unit: index  
- `r emo::ji("laboratory")` Laboratory method: Soil suspension combination pH-Reference Electrode  
- `r emo::ji("open_book")` Scientific reference: @mclean1983soil   
...
- `r emo::ji("id")` `code` sand.tot_usda.3a1_wpct  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Particle-Size Distribution Analysis using Pipette  
- `r emo::ji("open_book")` Scientific reference: @agriculture2019soil   


```{r, plot-sand, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for total sand content in wpct."}
...
```{r hist-sand1, echo=FALSE, fig.cap="Total sand content in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `code` silt.tot_usda.3a1_wpct  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Particle-Size Distribution Analysis using Pipette  
- `r emo::ji("open_book")` Scientific reference: @agriculture2019soil   


```{r, plot-silt, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for total silt content in wpct."}
...
```{r hist-silt1, echo=FALSE, fig.cap="Total silt content in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `wpg2_usda.3a2_wpct`  
- `r emo::ji("library")` Measurement unit: weigth percent  
- `r emo::ji("laboratory")` Laboratory method: Particle-Size Distribution Analysis by weight estimates  
- `r emo::ji("open_book")` Scientific reference: @grossman20022, @american2006standard   


```{r, plot-wpg, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for coarse fragments in wpct."}
...
```{r hist-wpg1, echo=FALSE, fig.cap="Coarse fragments in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `wr.1500kbar_usda.3c2_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Pressure-Membrane Extraction  
- `r emo::ji("open_book")` Scientific reference: @agriculture2019soil   


```{r, plot-wp, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Water Retention at 15 Bar (Permanent Wilting Point) in wpct."}
...
```{r hist-wp1, echo=FALSE, fig.cap="Organic carbon in weight percent histograms.", out.width="70%"}
...
- `r emo::ji("id")` `wr.33kbar_usda.3c1_wpct`  
- `r emo::ji("library")` Measurement unit: weight percent  
- `r emo::ji("laboratory")` Laboratory method: Pressure-Membrane Extraction  
- `r emo::ji("open_book")` Scientific reference: @agriculture2019soil   


```{r, plot-fc, fig.width=6, out.width="70%", fig.cap="Soil-depth histogram for Water Retention at 1/3 Bar (Field Capacity) in wpct."}
...
```{r hist-fc1, echo=FALSE, fig.cap="Water Retention at 1/3 Bar in weight percent histograms.", out.width="70%"}
