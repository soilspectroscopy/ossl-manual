...
- `r emo::ji("link")` Project website: <https://ncsslabdatamart.sc.egov.usda.gov/>  
- `r emo::ji("copyright")` Data license: [CC-BY](https://ncsslabdatamart.sc.egov.usda.gov/datause.aspx)  
- `r emo::ji("round_pushpin")` Unique sites: 9,061  
- `r emo::ji("clipboard")` Unique complete measurements: 76,813 (MIR) and 19,807 (VisNIR)  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/KSSL](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/KSSL)  
...
- `r emo::ji("link")` Project website: [ISRIC Data Hub](https://data.isric.org/geonetwork/srv/eng/catalog.search#/metadata/1b65024a-cd9f-11e9-a8f9-a0481ca9e724). 
...
- `r emo::ji("clipboard")` Unique complete measurements: 4308  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/ICRAF_ISRIC](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/ICRAF_ISRIC)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 41,719  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/LUCAS](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/LUCAS)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 3806  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/AFSIS](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/AFSIS)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 820  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/AFSIS2](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/AFSIS2)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 1852  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/CASSL](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/CASSL)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 259  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/Schiedung](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/Schiedung)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 184  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/Garrett](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/Garrett)  
...
- `r emo::ji("clipboard")` Unique complete measurements: 135  
- `r emo::ji("memo")` Import steps: [ossl-imports/dataset/Serbia](https://github.com/soilspectroscopy/ossl-imports/tree/main/dataset/Serbia)  
